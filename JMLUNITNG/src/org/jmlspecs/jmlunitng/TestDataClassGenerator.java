...
public class TestDataClassGenerator implements Constants
{
                        ...
                        final JCompilationUnit the_cUnitType, final Iterator the_Iter)
  {
    ...
    printConstructor();
    printCombinedIteratorClass(the_Iter);
    printClassEnd();
  }
   ...
   * class.
   */
  private void printObjectIterator()
  {
    writer.indent(4);
    writer.print("/**");
    writer.indent(4);
  ...
  private void printObjectCombinedIterator(final String the_name)
  {
    ...
    writer.indent(8);
    writer.print("new CombinedObjectParameterIterator(combIt, (Iterator)objectIt);");
    writer.indent(6);
