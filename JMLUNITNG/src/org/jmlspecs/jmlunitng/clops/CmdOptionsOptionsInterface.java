...
// Aliases: [-u, --universes]
  ...
  /**
   * @return true if the option Universes has been used
   * in the command line.
   */
   ...
   * @return the value of the option Universes if it has been set
   * using the arguments. Throws an {@code IllegalStateException} otherwise.
   */ 
...
// Aliases: [-dep, --deprication]
  ...
  /**
   * @return true if the option Deprication has been used
   * in the command line.
   */
   ...
   * @return the value of the option Deprication if it has been set
   * using the arguments. Throws an {@code IllegalStateException} otherwise.
   */ 
...
// Aliases: [-s, --safemath]
  ...
  /**
   * @return true if the option SafeMath has been used
   * in the command line.
   */
   ...
   * @return the value of the option SafeMath if it has been set
   * using the arguments. Throws an {@code IllegalStateException} otherwise.
   */ 
  boolean getSafeMath();
...
// Aliases: [-E]
  ...
  /**
   * @return true if the option Universesx has been used
   * in the command line.
   */
   ...
   * @return the value of the option Universesx if it has been set
   * using the arguments. Throws an {@code IllegalStateException} otherwise.
   */ 
