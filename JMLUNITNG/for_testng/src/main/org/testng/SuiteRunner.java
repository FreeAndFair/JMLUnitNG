...
public class SuiteRunner implements ISuite, Serializable {
  ...
  transient private ForgetfulTestListenerAdapter m_textReporter= new ForgetfulTestListenerAdapter();
  ...
  public void run() {
    ...
    try {
      ...
      if (m_suite.getVerbose() > 0) {
        int total = m_textReporter.skipped() + m_textReporter.passed() + m_textReporter.failed();
